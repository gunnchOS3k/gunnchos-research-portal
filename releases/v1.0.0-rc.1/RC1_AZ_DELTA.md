...
A — live PR #39 head: `905c9753fdb8945c0ede8857c31ec9edddf0def4` (branch `release/v1.0.0-rc1-ecosystem-freeze`)
...
I — demo bootstrap: `releases/v1.0.0-rc.1/demo/start_demo_services.sh` (Hub+client+reverse+Capsule WAIKE_HUB_URL inject)
J — WAIKE Pixel: Capsule→Chrome client handoff + CDP Sign-in → 18 tracks → lesson proven
...
Z — remaining owner action: complete OWNER_RC1_REVIEW.md; authorize merge of PR #39 and draft prereleases — do not publish final v1.0.0; Device OS draft handoff PR remains draft-only
