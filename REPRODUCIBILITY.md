        # Reproducibility — gunnchos Research Portal
...
# Expected: CI smoke pass; tests pass or documented skip
        ...
        **Real today:** Portfolio index, spine maps, evidence standards, contributor onboarding docs

        **Synthetic / demo-only:** Publication tracker placeholders, DOI tracker stubs

        **Planned:** Next.js optional site, automated portfolio sync from GitHub

        **Not claimed:** Operational deployment platform, commercial product catalog
