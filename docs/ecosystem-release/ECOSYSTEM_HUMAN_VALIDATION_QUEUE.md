...
| ID | Title | Participants | Evidence class | Protocol |
| --- | --- | --- | --- | --- |
| HV-GUNNCHAI-E6 | gunnchAI HUMAN_E6 evaluation | Adult internal evaluators (STEM students/staff) | HUMAN_VALIDATION_PENDING | docs/ecosystem-release/protocols/GUNNCHAI_HUMAN_EVAL_PROTOCOL.md |
| HV-WAIKE-STAFF | WAIKE staff alpha | Adult staff only | HUMAN_VALIDATION_PENDING | docs/ecosystem-release/protocols/WAIKE_STAFF_ALPHA_PROTOCOL.md |
| HV-WAIKE-LEARNER | WAIKE learner/instructor alpha | Adult learners + instructors | HUMAN_VALIDATION_PENDING | docs/ecosystem-release/protocols/WAIKE_LEARNER_INSTRUCTOR_ALPHA_PROTOCOL.md |
