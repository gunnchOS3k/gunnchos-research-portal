# Supervision questions (not sent)

Questions a CWC / 6G Flagship conversation might own — recorded here so they are not silently answered by software.

1. Which continuity metric family (time-above-threshold vs composite utility) should be frozen for Paper I before held-out campaigns?
2. What Gary / campus measurement assets are available without implying community deployment?
