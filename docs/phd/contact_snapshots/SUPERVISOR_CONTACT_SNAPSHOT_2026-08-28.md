# Supervisor contact snapshot — 2026-08-28

Generated: 2026-08-28T00:22:02Z  
...
|---|---|---|
| I / RQ1 | DIGITAL_REPRODUCIBLE_STRONG_CORE | 7gc-digital-twin @ dc43a56 (#31) statistical parity + device-OS profiles; SYNTHETIC_SIM; not field-complete |
| II / RQ2 | DIGITAL_REPRODUCIBLE_STRONG_CORE | spectrumx-ai-ran-gary @ 9060655 (#102 fidelity/checkpoint + info-equivalence) + readygary; SYNTHETIC_SIM; not production RAN/RL |
| III / RQ3 | DIGITAL_REPRODUCIBLE_STRONG_CORE_WITH_TRANSFER_PENDING | ntn-resilience-sim @ c4215fc (#28) + edge-io schema; SYNTHETIC_SIM; sim→measurement pending |
...
|---|---|---|---|---|---|
| `gunnchos-device-os` | ACCEPTED_MAIN_DRIFT | `28562a845620` | 122 | PASS | make reproduce |
| `gunnchos-hardware-industrial-design` | ACCEPTED_MAIN | `9ee0ef2f688b` | 67 | PASS | see REPRODUCIBILITY.md |
| `archive-of-life-artifact-world` | ACCEPTED_MAIN_DRIFT | `069243c36555` | 33 | PASS | see REPRODUCIBILITY.md |
| `gunnchAI3k` | ACCEPTED_MAIN_DRIFT | `4b4f411710e8` | 43 | PASS | make reproduce |
| `waike-research-ops` | ACCEPTED_MAIN_DRIFT | `8eb2827dc58f` | 54 | PASS | see REPRODUCIBILITY.md |
| `anime-aggressors` | ACCEPTED_MAIN_DRIFT | `b537c7bbd74c` | 79 | PASS | see REPRODUCIBILITY.md |
| `gunnchos-emergent-service-intent-protocols` | ACCEPTED_MAIN | `088c5e88e155` | 3 | PASS | see REPRODUCIBILITY.md |
| `pedestrian-pursuit` | ACCEPTED_MAIN_DRIFT | `5950ea791ed3` | 20 | PASS | see REPRODUCIBILITY.md |
| `beatlink-party` | ACCEPTED_MAIN_DRIFT | `23a95d152c2d` | 23 | PASS | see REPRODUCIBILITY.md |
| `edge-io-measurement-node` | ACCEPTED_MAIN | `af57fbdac857` | 38 | PASS | make reproduce |
| `gunnchos-research-portal` | ACCEPTED_MAIN_DRIFT | `f4155bc79831` | 9 | PASS | make reproduce |
| `ntn-resilience-sim` | ACCEPTED_MAIN_DRIFT | `c4215fc1039f` | 27 | PASS | make reproduce |
| `7gc-digital-twin` | ACCEPTED_MAIN_DRIFT | `dc43a567e3f2` | 30 | PASS | make reproduce |
| `spectrumx-ai-ran-gary` | ACCEPTED_MAIN_DRIFT | `9060655e7243` | 101 | PASS | make reproduce |
