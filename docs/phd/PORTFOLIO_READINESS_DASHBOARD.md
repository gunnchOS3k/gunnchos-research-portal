...
| `readygary-6g-beam-selection` | RQ2 | `core` | `cursor/supervisor-ready-portfolio-release-001` | `add0e474b0f2` | `STRUCTURED_CURRENT_FUTURE_LEGACY` | `DIGITAL_PASS` | `NOT_APPLICABLE` | `EXTERNAL_PENDING` | `NOT_APPLICABLE` | `SYNTHETIC_SIM` |
