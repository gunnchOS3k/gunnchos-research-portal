# WAIKE Integration — gunnchos-research-portal
...
Topics indexed in `waike-research-ops/knowledge_maps/waike_skill_tree.yaml` with repo link `gunnchos-research-portal`.
